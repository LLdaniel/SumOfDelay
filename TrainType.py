    ...
    def determineTrainType(self, name, country):
        match country:
            ...
            case 'DE':
                ...
                self.regional = ('ABR', 'AKN', 'ALX', 'BOB', 'CAN', 'DNR', 'EIB', 'ERB', 'EVB', 'FEG', 'FEX', 'HEX', 'HLB', 'HTB', 'HZL', 'IRE', 'LT', 'ME', 'MEr', 'MEX', 'MR', 'MRB', 'NBE', 'NEB', 'NEG', 'NOB', 'NWB', 'OE', 'OLA', 'PEG', 'PRE', 'RB', 'RbZ', 'RE', 'RTB', 'SBB', 'SHB', 'STB', 'SWE', 'UBB', 'VBG', 'VEC', 'VIA', 'WEG', 'WFB', 'BRB', 'RB-D', 'RE-D', 'DPN', 'DPN-G', 'DPN-D', 'RB-G', 'RE-G')
                ...
                self.loco = ('L', 'Lok', 'LOK', 'LOKF', 'LZ', 'Rf', 'Rf-D', 'Schadl', 'C', 'F', 'R', 'Schadt', 'Schadw', 'T', 'Tfzf', 'Ersatzlok')
